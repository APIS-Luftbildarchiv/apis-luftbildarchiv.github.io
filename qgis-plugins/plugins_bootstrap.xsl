...
<html>
    <head>
        <meta name="generator" content="phpQGISrepository" />
                    ...
                    <xsl:for-each select="/plugins/pyqgis_plugin">
                        <div class="card my-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="author">
                                    <strong>Author:</strong>&#160;<xsl:value-of select="author_name" />
                                </div>
                                <div class="version">
                                ...
                                <div class="downloads">
                                    <strong>Number of downloads:</strong>&#160;<xsl:value-of select="downloads" />
                                </div>
                            </div>
                        </div>
                    </xsl:for-each>
